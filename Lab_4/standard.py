...
def task_main(n , m, eps, Nmax, cheb, omg, part):
    ...
    #* Решаем сетки
    #-----------------------------------------#
    V1, nev1N, S1, eps_max1, nev0_1, point1 = solve_main(n , m, eps, Nmax, cheb, omg, part)
    V2, nev2N, S2, eps_max2, nev0_2, point2 = solve_main(int(2*n) , int(2*m), eps, Nmax, cheb, omg, part)
