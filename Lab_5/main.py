...
def graf(x, y):
    ...
    if funcflag == 'TEST_1':
        plt.subplot(1, 3, 1)
        plt.plot(x, y, marker='.', label='Функция')
        plt.plot(data1['x[j]'], data1['S[xj]'], label='Сплайн')
        plt.legend()
        plt.grid()
        plt.title("Функция")
        ...
        plt.subplot(1, 3, 2)
        plt.plot(x, y, marker='.', label='Функция')
        plt.plot(data1['x[j]'], data2["S'[xj]"], label='Сплайн')
        plt.legend()
        plt.grid()
        ...
        plt.subplot(1, 3, 3)
        plt.plot(x, y, marker='.', label='Функция')
        plt.plot(data1['x[j]'], data3["S''[xj]"], label='Сплайн')
        plt.legend()
        plt.grid()
